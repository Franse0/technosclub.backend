...
public class Entidad {
    ...
    public Entidad(int id, String nombre, String ubicacion, String img, String img_list,
                   String instagram, String facebook, String tiktok, String mail,
                   String youtube, String video_yt, String descripcion) {
        this.id = id;
        this.nombre = nombre;
